...
public interface Constants {
    ...
    String  JDBC_URL_SPARK ="jdbc.url.spark";
    ...
    String KAFKA_TOPICS = "kafka.tpoics";
    /**
     * Spark作业相关常量
     */
    String SPARK_APP_NAME_SESSION = "UserVisitSessionAnalyzeSpark";
    String SPARK_APP_NAME_PAGE = "PageOneStepConverSpark";
    ...
    String FIELD_CATEGOTY_ID = "categoryid";
    ...
    String PARAM_CATEGOTY_IDS = "categoryIds";
